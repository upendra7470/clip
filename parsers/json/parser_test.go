...
func TestParseMissingFile(t *testing.T) {
	...
	if !containsError(err.Error(), "file nonexistent.json does not exist") {
		t.Errorf("Parse() error = %q, want to contain 'file nonexistent.json does not exist'", err.Error())
	}
}
...
func TestErrorWrapping(t *testing.T) {
	...
	if !containsError(err.Error(), "file nonexistent.json does not exist") {
		t.Errorf("Error message = %q, want to contain 'file nonexistent.json does not exist'", err.Error())
	}
}
